...
const Register = () => {
  ...
  return (
      ...
      <div className="flex items-center justify-center min-h-screen">
              ...
              >
                <h1 className="text-white text-2xl font-semibold text-center mb-14">Sign Up</h1>
                <div className="mb-4 flex items-center gap-3 w-full px-5 py-2.5 rounded-full bg-[#333A5C]">
                  <input id="name" name="name" type="text" value={formData.name} placeholder="Full Name" onChange={handleChange} className='bg-transparent outline-none text-white' required />
                  {errors.email && (
                ...
                <div className=" w-full mb-4 flex items-center gap-3  px-5 py-2.5 rounded-full bg-[#333A5C]">
                  <input id="branch" name="branch" type="text" value={formData.branch} placeholder="Branch" onChange={handleChange} className='bg-transparent outline-none text-white' required />
                  {errors.email && (
                ...
                <div className=" w-full mb-4 flex items-center gap-3  px-5 py-2.5 rounded-full bg-[#333A5C]">
                  <input id="rollNo" name="rollNo" type="text" value={formData.rollNo} placeholder="Roll No." onChange={handleChange} className='bg-transparent outline-none text-white' required />
                  {errors.email && (
